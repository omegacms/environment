...
class Dotenv
{
     ...
     *
     * @var bool $isLoaded Determine which variables is loaded.
     */
     ...
     * @param  ?string $fileName      Holds the filename to load. (Optional)
     * @return void
     * @throws Exception
     */
    public static function load(string $directoryPath, string $fileName = null): void
    {
        $testPath = __DIR__ . '/fixtures';  // Corretto da '/fixture' a '/fixtures'
